...
fences_designspace = "tools/fences.designspace"

for instance in doc.instances:
    
    if instance.designLocation[tag_opsz] == 144.0  and instance.designLocation[tag_width] == 100 and instance.designLocation[tag_weight] == 400:
