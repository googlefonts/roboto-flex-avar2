...
#YTOS = ['C', 'G', 'J', 'O', 'Q', 'S', 'U', 'a', 'b', 'c', 'd', 'e', 'g', 'h', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'dollar', 'sterling', 'Euro', 'lira', 'manat', 'florin', 'coloncurrency', 'uni20B2', 'uni20B5', 'hryvnia', 'dollar.rvrn', 'cent.rvrn', 'coloncurrency.rvrn', 'uni20B2.rvrn', 'uni20B5.rvrn', 'hryvnia.rvrn', 'zero', 'two', 'three', 'five', 'six', 'eight', 'nine', 'zero.prop', 'two.prop', 'three.prop', 'five.prop', 'six.prop', 'eight.prop', 'nine.prop', 'percent', 'perthousand', 'cent', 'ampersand', 'Ccedilla', 'Ograve', 'Oacute', 'Ocircumflex', 'Otilde', 'Odieresis', 'Oslash', 'Ugrave', 'Uacute', 'Ucircumflex', 'Udieresis', 'agrave', 'aacute', 'acircumflex', 'atilde', 'adieresis', 'aring', 'ae', 'ccedilla', 'egrave', 'eacute', 'ecircumflex', 'edieresis', 'eth', 'ntilde', 'ograve', 'oacute', 'ocircumflex', 'otilde', 'odieresis', 'oslash', 'ugrave', 'uacute', 'ucircumflex', 'udieresis', 'thorn', 'amacron', 'abreve', 'aogonek', 'Cacute', 'cacute', 'Ccircumflex', 'ccircumflex', 'Cdotaccent', 'cdotaccent', 'Ccaron', 'ccaron', 'emacron', 'ebreve', 'edotaccent', 'eogonek', 'ecaron', 'gcircumflex', 'gbreve', 'gdotaccent', 'gcommaaccent', 'nacute', 'ncaron', 'omacron', 'obreve', 'ohungarumlaut', 'oe', 'rcaron', 'sacute', 'scircumflex', 'scedilla', 'scaron', 'tcedilla', 'Ohorn', 'ohorn', 'Uhorn', 'uhorn', 'Gcaron', 'gcaron', 'Oogonek', 'oogonek', 'aringacute', 'aeacute', 'oslashacute', 'adblgrave', 'ainvertedbreve', 'edblgrave', 'einvertedbreve', 'Odblgrave', 'odblgrave', 'Oinvertedbreve', 'oinvertedbreve', 'rdblgrave', 'rinvertedbreve', 'Scommaaccent', 'scommaaccent', 'tcommaaccent', 'Odieresismacron', 'odieresismacron', 'Otildemacron', 'otildemacron', 'Odotaccentmacron', 'odotaccentmacron', 'Schwa', 'schwa', 'adotbelow', 'ahookabove', 'acircumflexacute', 'acircumflexgrave', 'acircumflexhookabove', 'acircumflextilde', 'acircumflexdotbelow', 'abreveacute', 'abrevegrave', 'abrevehookabove', 'abrevetilde', 'abrevedotbelow', 'edotbelow', 'ehookabove', 'etilde', 'ecircumflexacute', 'ecircumflexgrave', 'ecircumflexhookabove', 'ecircumflextilde', 'ecircumflexdotbelow', 'Odotbelow', 'odotbelow', 'Ohookabove', 'ohookabove', 'Ocircumflexacute', 'ocircumflexacute', 'Ocircumflexgrave', 'ocircumflexgrave', 'Ocircumflexhookabove', 'ocircumflexhookabove', 'Ocircumflextilde', 'ocircumflextilde', 'Ocircumflexdotbelow', 'ocircumflexdotbelow', 'Ohornacute', 'ohornacute', 'Ohorngrave', 'ohorngrave', 'Ohornhookabove', 'ohornhookabove', 'Ohorntilde', 'ohorntilde', 'Ohorndotbelow', 'ohorndotbelow', 'Udotbelow', 'udotbelow', 'Uhorndotbelow', 'uhorndotbelow', 'Theta', 'Omega', 'alpha', 'beta', 'delta', 'epsilon', 'eta', 'theta', 'rho', 'finalsigma', 'sigma', 'upsilon', 'phi', 'psi', 'omega', ' Ieukran', 'Ze', 'Odieresiscyr', 'Ecyr', 'Zedescendercyr', 'Esdescendercyr', 'Schwacyr', 'Obarcyr', 'abrevecyr', 'adieresiscyr', 'be', 'io', 'iebrevecyr', 'ze', 'odieresiscyr', 'ecyr', 'ieukran', 'tshe', 'zedescendercyr', 'esdescendercyr', 've.bgr', 'ghe.bgr', 'ze.bgr', 'sha.bgr', 'hard.bgr', 'soft.bgr', 'be.locl', 'amacroncyr', 'iemacroncyr', 'Omacroncyr', 'omacroncyr', 'Obrevecyr', 'obrevecyr', 'Emacroncyr', 'emacroncyr', 'Ebrevecyr', 'ebrevecyr', 'Yumacron', 'yumacron'  ]
